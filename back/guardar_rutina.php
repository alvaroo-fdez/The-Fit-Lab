...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO dietas (usuario_id, nivel, altura, peso, peso_deseado, edad, sexo, objetivo, requisitos) 
                            VALUES (:usuario_id, :nivel, :altura, :peso, :peso_deseado, :edad, :sexo, :objetivo, :requisitos)");
